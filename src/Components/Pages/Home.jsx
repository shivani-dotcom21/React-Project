  ...
  return (
    <>
      <section className="font-poppins">
        <video class="relative w-[100%] h-fit overflow-hidden" controls>
          <source
            src="https://www.omegawatches.com/media/wysiwyg/video/PP-007-First-Light-videoLoop-735x510_1.mp4"
            type="video/mp4"
          />
        </video>
        <div className="hidden lg:block absolute top-70 left-20 z-999 lg:absolute top-100 left-20 z-999 text-white">
          <p>SEAMASTER</p>
          <p className="text-5xl my-3">007 FIRST LIGHT </p>
        ...
        <div className="relative">
          <figure>
            <img src="https://www.omegawatches.com/media/wysiwyg/SP76-Moonwatch-desktop-small.jpg?" />
          </figure>
          <div className="hidden lg:block absolute top-100 left-20 text-white z-999">
            <p>ICONIC SEINCE 1957</p>
            <p className="text-5xl my-3">
              MOON WATCHES <br />
              PROFESSIONAL{" "}
            </p>
            <button className="border bg-opaque p-2 hover:bg-red-600 hover:text-white hover:bg-red-600 hover:text-white">
              DISCOVER THE WATCHES
            </button>
          </div>
        </div>
        ...
        <section className="bg-gray-100 w-full h-[850px] ">
          <div className="grid gap-5 justify-center pt-10">
            ...
            <h1 className="text-3xl font-robotMono">A SUCCESSFULL FAILURE </h1>
          </div>

          <div className=" relative flex justify-between items-center lg:mx-30 lg:my-20 ">
            <div>
              ...
              <figure className=" lg:absolute top-0 right-170  border-5 border-black
                       absolute left-60 w-75 border-5 border-white ">
                <img
              ...
              <figure className=" lg:absolute top-10 border-5 z-999 border-white
                                  absolute top-5  border-5 border-white">
                <img
              ...
              <video
                class=" lg:absolute top-70 left-60 w-75 h-fit border-5 border-white
                      absolute top-70 left-0 w-75 h-fit border-5 border-white "
                controls
              >
                <source
            ...
            <div className="hidden lg:block w-100 mt-20">
              <div>
                ...
                <p className="font-robotMono">
                  On April 11 1970, NASA's third crewed lunar landing, Apollo 13
                  set out for the Fra Mauro highlands to continue humankind's
                  exploration of the Moon.
                </p>
              </div>
              <div className="flex items-center gap-5 my-5">
                <IoIosArrowBack className="hover: w-[35px] h-[35px] p-2 hover:bg-red-600 hover:text-white" />{" "}
                <IoIosArrowForward className="hover:border-1 w-[35px] h-[35px] p-2 hover:bg-red-600 hover:text-white" />
                <p> 1 / 5</p>
              </div>
            </div>
          </div>
        ...
        <section className="grid justify-center text-center m-20 ">
          <div>
            <h1 className="text-5xl text-red-800 font-robotMono">Aqua Terra in Black</h1>
        ...
        <section className="grid cols-1 lg:grid-cols-2 items-center justify-center gap-30 text-center lg:m-20 ">
          <div className="w-full lg:w-75">
            <h1 className="text-5xl text-red-800 font-headline">Forever Timeless</h1>
        ...
        <section className="max-w-[1320px] my-30 ">
          <div className="text-center">
            <h1 className="text-5xl text-red-800 font-headline"> NEWS & STORIES</h1>
            ...
            <div className="w-fit h-fit lg:w-[250px] lg:h-[450px] grid gap-4 shadow-lg shadow-gray-400 ">
              ...
              <div className="p-3 grid gap-4 text-center lg:text-left">
                ...
                <p className="hidden lg:block font-robotMono">
                  One of Switzerland's  middle-distance runners is a
                   talent in the world of athletics.{" "}
                </p>
              </div>
            </div>
